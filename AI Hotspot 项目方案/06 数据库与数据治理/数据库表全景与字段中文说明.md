...
> 基准日期：2026-07-25
> 当前阶段：M10 本地交付后的信源质量、RAG 与 Agent 可靠性专项（Flyway V001～V038）
> 数据库：PostgreSQL 16 + pgvector 0.8.5
> 本文只把已经由迁移创建的对象称为“现有表”。2026-07-25 实时核对已执行到 V038，M7～M10、RAG 阶段 B、Agent 可靠性、信源质量周报、发布时间来源、Connector 轮询结果与回答反馈对象均为现有结构。

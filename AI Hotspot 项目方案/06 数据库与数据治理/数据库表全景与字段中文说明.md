...
> 基准日期：2026-07-22
> 当前阶段：M10 本地交付后的信源质量与 RAG 专项（Flyway V001～V030）
> 数据库：PostgreSQL 16 + pgvector 0.8.5
> 本文只把已经由迁移创建的对象称为“现有表”。2026-07-22 已执行到 V030，M7～M10、RAG v3.4、信源质量周报与发布时间来源对象均为现有结构。
...
7. 已执行的迁移绝不修改；当前到 V030，后续修复只能新增 V031+。

...
> 基准日期：2026-07-20
> 当前阶段：M10 本地交付（Flyway V001～V020）
> 数据库：PostgreSQL 16 + pgvector 0.8.5
> 本文只把已经由迁移创建的对象称为“现有表”。2026-07-20 已执行到 V020，M7～M10 对象均已转为现有表。
...
7. 已执行的迁移绝不修改；V020 已建立 RAG 黄金集，后续修复只能新增 V021+。

...
> 基准日期：2026-07-22
> 当前阶段：M10 本地交付后的信源质量与 RAG 专项（Flyway V001～V028）
...
7. 已执行的迁移绝不修改；当前到 V028，后续修复只能新增 V029+。

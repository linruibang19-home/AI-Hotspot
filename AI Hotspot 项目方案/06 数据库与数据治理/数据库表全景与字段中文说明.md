...
> 基准日期：2026-07-22
> 当前阶段：M10 本地交付后的稳定性与 RAG 质量加固（Flyway V001～V024）
> 数据库：PostgreSQL 16 + pgvector 0.8.5
> 本文只把已经由迁移创建的对象称为“现有表”。2026-07-22 已执行到 V024，M7～M10 与 RAG v2 对象均为现有结构。
...
7. 已执行的迁移绝不修改；当前到 V024，后续修复只能新增 V025+。
